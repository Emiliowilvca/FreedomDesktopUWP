...
{
    public class BankReleaseCheckViewModel : BaseViewModel
    {
        public BankReleaseCheckViewModel()
        {
            Title = Lang.ReleaseCheck;
            PageTitle = new PageTitle( Lang.ReleaseCheck, MaterialDesignIcons.UploadMultiple);
        }
