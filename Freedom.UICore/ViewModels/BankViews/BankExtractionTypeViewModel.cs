...
{
    public class BankExtractionTypeViewModel : BaseViewModel
    {
        public BankExtractionTypeViewModel()
        {
            Title = Lang.BankExtractionType;
            PageTitle = new PageTitle(Lang.BankExtractionType, MaterialDesignIcons.CommentArrowLeft);
        }
    }
}