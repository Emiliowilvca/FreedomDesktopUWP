...
{
    public class BankExtractionViewModel : BaseViewModel
    {
        public BankExtractionViewModel()
        {
            Title = Lang.BankExtraction;
            PageTitle = new PageTitle(Lang.BankExtraction, MaterialDesignIcons.BankTransferOut);
        }
