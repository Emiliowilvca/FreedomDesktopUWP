...
{
    public class BankExtractionReportViewModel : BaseViewModel
    {
        public BankExtractionReportViewModel()
        {
            Title = Lang.BankExtractionReport;
            PageTitle = new PageTitle(Lang.BankExtractionReport, MaterialDesignIcons.ScriptTextPlayOutline);
        }
