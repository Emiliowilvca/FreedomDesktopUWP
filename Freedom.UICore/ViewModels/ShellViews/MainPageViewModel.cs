...
using Freedom.UICore.Views.CarrierViews;
using Freedom.UICore.Views.CashBoxViews;
...
using Freedom.UICore.Views.MoneyViews;
using Freedom.UICore.Views.OperationViews;
using Freedom.UICore.Views.PaymentViews;
using Freedom.UICore.Views.ProductViews;
using Freedom.UICore.Views.ProviderViews;
using Freedom.UICore.Views.PurchaseViews;
using Freedom.UICore.Views.ReportViews;
using Freedom.UICore.Views.ReturnViews;
using Freedom.UICore.Views.SaleViews;
using Freedom.UICore.Views.SettingViews;
using Freedom.UICore.Views.ShopViews;
using Freedom.UICore.Views.StatusBarViews;
using Freedom.UICore.Views.TransferViews;
using Freedom.UICore.Views.VehicleViews;
