...
{
    public class CashBoxCloseViewModel : BaseViewModel
    {
        public CashBoxCloseViewModel()
        {
            Title = Lang.CashBoxClose;
            PageTitle = new PageTitle(Lang.CashBoxClose, MaterialDesignIcons.CashLock);
        }
    }
}