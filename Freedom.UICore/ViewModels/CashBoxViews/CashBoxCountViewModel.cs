...
namespace Freedom.UICore.ViewModels.CashBoxViews
{
    public class CashBoxCountViewModel : BaseViewModel
    {
        public CashBoxCountViewModel()
        {
            Title = Lang.CashboxCount;
            PageTitle = new PageTitle(Lang.CashboxCount, MaterialDesignIcons.CashRefund);
        }
