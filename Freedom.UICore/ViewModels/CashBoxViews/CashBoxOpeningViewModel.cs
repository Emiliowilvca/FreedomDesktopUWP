...
{
    public class CashBoxOpeningViewModel : BaseViewModel
    {
        public CashBoxOpeningViewModel()
        {
            PageTitle = new PageTitle(Lang.CashBoxOpening, MaterialDesignIcons.CashPlus);
        }
    }
}