...
{
    public class ExpenceTypeSearchViewModel : BaseViewModel
    {
        ...
        public ExpenceTypeSearchViewModel(IExpenceTypeService expenceTypeService,
                                          ILoadMoreHelper loadMoreHelper)
        {
            ...
            DeleteCommand = new RelayCommand<ExpenceTypeINFO>(DeleteCommandExecute);
            Collection = new ObservableCollection<ExpenceTypeINFO>();
            LoadCollection();
        }
        ...
        private async void DeleteCommandExecute(ExpenceTypeINFO entity)
        {
            try
            {
                ...
                if (result == ContentDialogResult.Primary)
                {
                    ...
                    XResponse response = await _expenceTypeService.DeleteAsync(_prefix, _version, _controller, "", entity.Id,
        ...
        private void ConfirmCommandExecute()
        {
            ...
            WeakReferenceMessenger.Default.Send(new VMSendMessage<ExpenceTypeINFO>(SelCollection), _sendMessageToken);
        ...
        private async void SearchCommandExecute()
        {
            ...
            {
                _messageService.ShowMessage(ex.Message, "Search Command error");
            }
            finally
            {
                _cancelTokenSource.Dispose();
        ...
        private ObservableCollection<ExpenceTypeINFO> _collection;

        public ObservableCollection<ExpenceTypeINFO> Collection
        {
            get => _collection;
        ...
        private async Task GetCollectionAsync<T>(T request, string methodName, bool clearBeforeLoading, CancellationToken token) where T : class
        {
            ...
            var response = await _expenceTypeService.GetListAsync(_prefix, _version, _controller, methodName,
            ...
            var collection = _mapper.Map<List<ExpenceTypeINFO>>(response.Collection);
