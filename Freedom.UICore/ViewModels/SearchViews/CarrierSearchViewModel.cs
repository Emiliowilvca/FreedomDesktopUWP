...
{
    public class CarrierSearchViewModel : BaseViewModel
    {
        ...
        public CarrierSearchViewModel(ILoadMoreHelper loadMoreHelper,
                                      ICarrierService carrierService)
        {
             PageTitle = new PageTitle(Lang.SearchOfCarrier, MaterialDesignIcons.TruckFast);
            ...
            DeleteCommand = new RelayCommand<CarrierINFO>(DeleteCommandExecute);
            Collection = new ObservableCollection<CarrierINFO>();
            LoadCollection();
        }
        ...
        private async void DeleteCommandExecute(CarrierINFO entity)
        {
            try
            {
                ...
                if (result == ContentDialogResult.Primary)
                {
                    ...
                    XResponse response = await _carrierService.DeleteAsync(_prefix, _version, _controller, "", entity.Id,
        ...
        private void ConfirmCommandExecute()
        {
            ...
            WeakReferenceMessenger.Default.Send(new VMSendMessage<CarrierINFO>(SelCollection), _sendMessageToken);
        ...
        private ObservableCollection<CarrierINFO> _collection;

        public ObservableCollection<CarrierINFO> Collection
        {
            get => _collection;
        ...
        private async Task GetCollectionAsync<T>(T request, string methodName, bool clearBeforeLoading, CancellationToken token) where T : class
        {
            ...
            var response = await _carrierService.GetListAsync(_prefix, _version, _controller, methodName,
            ...
            var collection = _mapper.Map<List<CarrierINFO>>(response.Collection);
