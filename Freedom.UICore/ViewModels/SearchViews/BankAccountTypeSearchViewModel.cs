...
{
    public class BankAccountTypeSearchViewModel : BaseViewModel
    {
        ...
        public BankAccountTypeSearchViewModel(IBankAccountTypeService bankAccountTypeService,
                                              ILoadMoreHelper loadMoreHelper)
        {
            _bankAccountTypeService = bankAccountTypeService;
            _loadMoreHelper = loadMoreHelper;
             PageTitle = new PageTitle(Lang.SearchOfBankAccountType, MaterialDesignIcons.CommentBookmark);
            ...
            DeleteCommand = new RelayCommand<BankAccountTypeINFO>(DeleteCommandExecute);
            Collection = new ObservableCollection<BankAccountTypeINFO>();
            LoadCollection();
        }
        ...
        private async void DeleteCommandExecute(BankAccountTypeINFO entity)
        {
            try
            {
                ...
                if (result == ContentDialogResult.Primary)
                {
                    ...
                    XResponse response = await _bankAccountTypeService.DeleteAsync(_prefix, _version, _controller, "", entity.Id,
        ...
        {
            List<BankAccountTypeINFO> SelCollection = Collection.Where(x => x.IsSelected == true).ToList();
            ...
            WeakReferenceMessenger.Default.Send(new VMSendMessage<BankAccountTypeINFO>(SelCollection), _sendMessageToken);
        ...
        private ObservableCollection<BankAccountTypeINFO> _collection;

        public ObservableCollection<BankAccountTypeINFO> Collection
        {
            get => _collection;
        ...
        private async Task GetCollectionAsync<T>(T request, string methodName, bool clearBeforeLoading, CancellationToken token) where T : class
        {
            ...
            ListResponse<BankAccountTypeRTO> response = await _bankAccountTypeService.GetListAsync(_prefix, _version, _controller, methodName,
            ...
            List<BankAccountTypeINFO> collection = _mapper.Map<List<BankAccountTypeINFO>>(response.Collection);
