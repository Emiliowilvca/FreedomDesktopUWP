...
{
    public class PaymentTypeSearchViewModel : BaseViewModel
    {
        ...
        public PaymentTypeSearchViewModel(IPaymentTypeService paymentTypeService, ILoadMoreHelper loadMoreHelper)
        {
            _paymentTypeService = paymentTypeService;
            _loadMoreHelper = loadMoreHelper;
            PageTitle = new PageTitle(Lang.SearchOfPaymentTypes, MaterialDesignIcons.CreditCardMarkerOutline);
            ...
            DeleteCommand = new RelayCommand<PaymentTypeINFO>(DeleteCommandExecute);
            Collection = new ObservableCollection<PaymentTypeINFO>();
            LoadCollection();
        }
        ...
        private async void DeleteCommandExecute(PaymentTypeINFO entity)
        {
            try
            {
                ...
                if (result == ContentDialogResult.Primary)
                {
                    ...
                    XResponse response = await _paymentTypeService.DeleteAsync(_prefix, _version, _controller, "", entity.Id,
        ...
        private void ConfirmCommandExecute()
        {
            ...
            WeakReferenceMessenger.Default.Send(new VMSendMessage<PaymentTypeINFO>(SelCollection), _sendMessageToken);
        ...
        private ObservableCollection<PaymentTypeINFO> _collection;

        public ObservableCollection<PaymentTypeINFO> Collection
        {
            get => _collection;
        ...
        private async Task GetCollectionAsync<T>(T request, string methodName, bool clearBeforeLoading, CancellationToken token) where T : class
        {
            ...
            var response = await _paymentTypeService.GetListAsync(_prefix, _version, _controller, methodName,
            ...
            var collection = _mapper.Map<List<PaymentTypeINFO>>(response.Collection);
