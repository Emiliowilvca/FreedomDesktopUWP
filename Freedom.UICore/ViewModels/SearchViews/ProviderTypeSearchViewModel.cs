...
{
    public class ProviderTypeSearchViewModel : BaseViewModel
    {
        ...
        public ProviderTypeSearchViewModel(IProviderTypeService providerTypeService,
                                           ILoadMoreHelper loadMoreHelper)
        {
            ...
            DeleteCommand = new RelayCommand<ProviderTypeINFO>(DeleteCommandExecute);
            Collection = new ObservableCollection<ProviderTypeINFO>();
            LoadCollection();
        }
        ...
        private async void DeleteCommandExecute(ProviderTypeINFO entity)
        {
            try
            {
                ...
                if (result == ContentDialogResult.Primary)
                {
                    ...
                    XResponse response = await _providerTypeService.DeleteAsync(_prefix, _version, _controller, "", entity.Id,
        ...
        private async void LoadMoreCommandExecute()
        {
            ...
            {
                _messageService.ShowMessage(ex.Message,"LoadMoreCommandExecute");
            }
            finally
            {
                _cancelTokenSource.Dispose();
        ...
        private void ConfirmCommandExecute()
        {
            ...
            WeakReferenceMessenger.Default.Send(new VMSendMessage<ProviderTypeINFO>(SelCollection), _sendMessageToken);
        ...
        private async void SearchCommandExecute()
        {
            ...
            {
                _messageService.ShowMessage(ex.Message, "SearchCommandExecute");
            }
            finally
            {
                _cancelTokenSource.Dispose();
        ...
        private ObservableCollection<ProviderTypeINFO> _collection;

        public ObservableCollection<ProviderTypeINFO> Collection
        {
            get => _collection;
        ...
        private async void LoadCollection()
        {
            ...
            {
                _messageService.ShowMessage(ex.Message,"Load Collections");
            }
            finally
            {
                _cancelTokenSource.Dispose();
        ...
        private async Task GetCollectionAsync<T>(T request, string methodName, bool clearBeforeLoading, CancellationToken token) where T : class
        {
            ...
            var response = await _providerTypeService.GetListAsync(_prefix, _version, _controller, methodName,
            ...
            var collection = _mapper.Map<List<ProviderTypeINFO>>(response.Collection);
