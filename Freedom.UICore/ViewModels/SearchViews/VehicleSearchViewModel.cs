    ...
    public class VehicleSearchViewModel : BaseViewModel
    {
                                      ...
                                      ILoadMoreHelper loadMoreHelper)
        {
            ...
            _loadMoreHelper = loadMoreHelper;
             PageTitle = new PageTitle(Lang.SearchOfVehicle, MaterialDesignIcons.TruckCargoContainer);
            ...
            DeleteCommand = new RelayCommand<VehicleINFO>(DeleteCommandExecute);
            Collection = new ObservableCollection<VehicleINFO>();
            LoadCollection();
        }
        ...
        private async void DeleteCommandExecute(VehicleINFO entity)
        {
            try
            {
                ...
                if (result == ContentDialogResult.Primary)
                {
                    ...
                    XResponse response = await _vehicleService.DeleteAsync(_prefix, _version, _controller, "", entity.Id,
        ...
        private void ConfirmCommandExecute()
        {
            ...
            WeakReferenceMessenger.Default.Send(new VMSendMessage<VehicleINFO>(SelCollection), _sendMessageToken);
        ...
        private ObservableCollection<VehicleINFO> _collection;

        public ObservableCollection<VehicleINFO> Collection
        {
            get => _collection;
        ...
        private async Task GetCollectionAsync<T>(T request, string methodName, bool clearBeforeLoading, CancellationToken token) where T : class
        {
            ...
            var response = await _vehicleService.GetListAsync(_prefix, _version, _controller, methodName,
            ...
            var collection = _mapper.Map<List<VehicleINFO>>(response.Collection);
