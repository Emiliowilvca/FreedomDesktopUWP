...
{
    public class CustomerAccountSearchViewModel : BaseViewModel
    {
        ...
        public CustomerAccountSearchViewModel(ICustomerAccountService customerAccountService,
                                              ILoadMoreHelper loadMoreHelper)
        {
            _customerAccountService = customerAccountService;
            _loadMoreHelper = loadMoreHelper;
             PageTitle = new PageTitle(Lang.SearchOfCustomerAccount, MaterialDesignIcons.BadgeAccountHorizontalOutline);
            ...
            DeleteCommand = new RelayCommand<CustomerAccountINFO>(DeleteCommandExecute);
            Collection = new ObservableCollection<CustomerAccountINFO>();
            LoadCollection();
        ...
        private async void DeleteCommandExecute(CustomerAccountINFO entity)
        {
            try
            {
                ...
                if (result == ContentDialogResult.Primary)
                {
                    ...
                    XResponse response = await _customerAccountService.DeleteAsync(_prefix, _version, _controller, "", entity.Id,
        ...
        private void ConfirmCommandExecute()
        {
            ...
            WeakReferenceMessenger.Default.Send(new VMSendMessage<CustomerAccountINFO>(SelCollection), _sendMessageToken);
        ...
        private ObservableCollection<CustomerAccountINFO> _collection;

        public ObservableCollection<CustomerAccountINFO> Collection
        {
            get => _collection;
        ...
        private async Task GetCollectionAsync<T>(T request, string methodName, bool clearBeforeLoading, CancellationToken token) where T : class
        {
            ...
            var response = await _customerAccountService.GetListAsync(_prefix, _version, _controller, methodName,
            ...
            var collection = _mapper.Map<List<CustomerAccountINFO>>(response.Collection);
