...
{
    public class SubGroupSearchViewModel : BaseViewModel
    {
        ...
        public SubGroupSearchViewModel(ISubGroupService subGroupService,
                                       ILoadMoreHelper loadMoreHelper)
        {
            ...
            DeleteCommand = new RelayCommand<SubGroupINFO>(DeleteCommandExecute);
            Collection = new ObservableCollection<SubGroupINFO>();
            LoadCollection();
        }
        ...
        private async void DeleteCommandExecute(SubGroupINFO entity)
        {
            try
            {
                ...
                if (result == ContentDialogResult.Primary)
                {
                    ...
                    XResponse response = await _subGroupService.DeleteAsync(_prefix, _version, _controller, "", entity.Id,
        ...
        private void ConfirmCommandExecute()
        {
            ...
            WeakReferenceMessenger.Default.Send(new VMSendMessage<SubGroupINFO>(SelCollection), _sendMessageToken);
        ...
        private ObservableCollection<SubGroupINFO> _collection;

        public ObservableCollection<SubGroupINFO> Collection
        {
            get => _collection;
        ...
        private async Task GetCollectionAsync<T>(T request, string methodName, bool clearBeforeLoading, CancellationToken token) where T : class
        {
            ...
            var response = await _subGroupService.GetListAsync(_prefix, _version, _controller, methodName,
            ...
            var collection = _mapper.Map<List<SubGroupINFO>>(response.Collection);
