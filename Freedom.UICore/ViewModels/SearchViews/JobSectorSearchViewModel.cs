...
{
    public class JobSectorSearchViewModel : BaseViewModel
    {
        ...
        public JobSectorSearchViewModel(IJobSectorService jobSectorService,
                                        ILoadMoreHelper loadMoreHelper)
        {
            ...
            DeleteCommand = new RelayCommand<JobSectorINFO>(DeleteCommandExecute);
            Collection = new ObservableCollection<JobSectorINFO>();
            LoadCollection();
        }
        ...
        private async void DeleteCommandExecute(JobSectorINFO entity)
        {
            try
            {
                ...
                if (result == ContentDialogResult.Primary)
                {
                    ...
                    XResponse response = await _jobSectorService.DeleteAsync(_prefix, _version, _controller, "", entity.Id,
        ...
        private void ConfirmCommandExecute()
        {
            ...
            WeakReferenceMessenger.Default.Send(new VMSendMessage<JobSectorINFO>(SelCollection), _sendMessageToken);
        ...
        private ObservableCollection<JobSectorINFO> _collection;

        public ObservableCollection<JobSectorINFO> Collection
        {
            get => _collection;
        ...
        private async Task GetCollectionAsync<T>(T request, string methodName, bool clearBeforeLoading, CancellationToken token) where T : class
        {
            ...
            var response = await _jobSectorService.GetListAsync(_prefix, _version, _controller, methodName,
            ...
            var collection = _mapper.Map<List<JobSectorINFO>>(response.Collection);
