...
namespace Freedom.UICore.ViewModels.SearchViews
{
    public class EmployeeSearchViewModel : BaseViewModel
    {
        ...
        public EmployeeSearchViewModel(IEmployeeService employeeService, 
                                       ILoadMoreHelper loadMoreHelper)
        {
            _employeeService = employeeService;
            _loadMoreHelper = loadMoreHelper;
             PageTitle = new PageTitle(Lang.SearchOfEmployees, MaterialDesignIcons.AccountHardHat);
            ...
            DeleteCommand = new RelayCommand<EmployeeINFO>(DeleteCommandExecute);
        ...
        private async void DeleteCommandExecute(EmployeeINFO entity)
        {
            try
            {
                ...
                if (result == ContentDialogResult.Primary)
                {
                    ...
                    IsBusy = true;
                    XResponse response = await _employeeService.DeleteAsync(_prefix, _version, _controller, "", entity.Id,
        ...
        private void ConfirmCommandExecute()
        {
            ...
            WeakReferenceMessenger.Default.Send(new VMSendMessage<EmployeeINFO>(SelCollection), _sendMessageToken);
        ...
        private ObservableCollection<EmployeeINFO> _collection;
        ...
        private async Task GetCollectionAsync<T>(T request, string methodName, bool clearBeforeLoading, CancellationToken token) where T : class
        {
            ...
            var response = await _employeeService.GetListAsync(_prefix, _version, _controller, methodName,
            ...
            var collection = _mapper.Map<List<EmployeeINFO>>(response.Collection);
